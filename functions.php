...
// //This is from Eric/Matthew from SVA class Nov 8th
// //Enqueue scripts 
...
?>
	...
	<?php if ($args['avatar_size'] != 1) echo get_avatar( $comment, $args['77'] ); ?>
	<?php printf(__('<span class="fn">%s</span> <span class="says">ahhhh:</span>'), get_comment_author_link()) ?>
	</div>
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'footer-menu' => __('Fabulous Footer Menu', 'html5blank') // Footer Navigation (duplicate as many menus as you need!)
    ));
}
...
// Create 20 Word Callback for Custom Post Excerpts, call using html5wp_excerpt('html5wp_custom_post');
...
{
    $myavatar = get_template_directory_uri() . '/img/green-circle.png';
...
function create_post_type_html5()
{
    ...
    register_post_type('friends', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Friends', 'friends'), // Rename these to suit
            'singular_name' => __('Friend', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Friend', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Friend', 'html5blank'),
            'new_item' => __('New Friend', 'html5blank'),
            'view' => __('View Friend', 'html5blank'),
            'view_item' => __('View Friends', 'html5blank'),
            'search_items' => __('Search Friends', 'html5blank'),
            'not_found' => __('No Friends found', 'html5blank'),
            'not_found_in_trash' => __('No Friends found in Trash', 'html5blank')
        ),
        'public' => true,
